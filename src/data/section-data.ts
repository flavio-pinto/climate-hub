...
export const no2: SectionInfo = {
  name: "NO2",
  description: "Nitrogen dioxide (NO2) is a significant air pollutant primarily stemming from combustion processes in vehicles, industrial activities, and power plants. Though not a greenhouse gas itself, NO2 plays a pivotal role in atmospheric processes. It reacts with other pollutants to form ground-level ozone, a potent greenhouse gas and a major component of smog. The presence of NO2 in the atmosphere is associated with adverse health effects, particularly respiratory and cardiovascular issues in humans. In the context of climate change, the indirect impact of NO2 lies in its role in the formation of secondary pollutants, which not only contribute to global warming but also compromise air quality. To mitigate these effects, strategies involve adopting cleaner technologies, promoting sustainable transportation, and enforcing regulations aimed at reducing NO2 emissions. These efforts are crucial not only for addressing climate change but also for safeguarding public health and improving overall air quality.",
  image: "",
  whatCanWeDo: [
...
export const arcticIce: SectionInfo = {
  name: "Polar Glaciers",
